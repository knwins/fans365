export default {
  ...
  /*bind */
  'menu.dashboard.bindManage': 'Bind Manage',
  'menu.dashboard.myBind': 'My Bind',
  /*TSTask */
  ...
  'menu.account': 'Profile Page',
  'menu.account.center': 'Center',
  'menu.account.settings': 'Profile Setting',
