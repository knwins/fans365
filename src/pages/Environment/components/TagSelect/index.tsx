...
const TagSelect: FC<TagSelectProps> & { Option: typeof TagSelectOption } = (props) => {
  ...
  const { expandText = <FormattedMessage id="pages.expand" />, 
  collapseText = <FormattedMessage id="pages.collapse" />, 
  selectAllText = <FormattedMessage id="pages.select.all" />} = actionsText;
